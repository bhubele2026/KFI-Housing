...
// describe block below is shared with `portfolio-map.test.tsx` — see the
// helper module for details on why the shim exists and how it flips the
// SSE-subscription branch on under jsdom.
