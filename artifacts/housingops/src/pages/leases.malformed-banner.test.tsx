...
vi.mock("@workspace/api-client-react", () => {
  ...
  return {
    ...
    useListInsuranceCertificates: listHook([]),
    ...
    getListInsuranceCertificatesQueryKey: emptyQueryKey("/api/insurance-certificates"),
    ...
    useCreateInsuranceCertificate: emptyMutation(),
    useUpdateInsuranceCertificate: emptyMutation(),
    useDeleteInsuranceCertificate: emptyMutation(),
